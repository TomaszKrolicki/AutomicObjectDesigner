    ...
    <div className='md:px-4 py-2.5 container w-800'>
      <form onSubmit={handleSubmit}>
        <label htmlFor="WindowsServer" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Select Server</label>
          ...
          <option value={"WIN01"}>WIN01</option>
          <option value={"WIN02"}>WIN02</option>
          <option value={"WIN03"}>WIN03</option>
          <option value={"WIN04"}>WIN04</option>
        </select>
        <label htmlFor="WindowsLogin" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400 my-3">Select Windows Login Object</label>
              ...
              <option value={"001FHS"}>001FHS</option>
          <option value={"002FHS"}>002FHS</option>
          <option value={"003FHS"}>003FHS</option>
          <option value={"004FHS"}>004FHS</option>
        </select>
        ...
        <input type="text" onChange={handleChange} value={formData.ProcessName}  name='ProcessName' minLength="7" maxLength="7" id="ProcessName" placeholder='Min/Max 7 characters' className={cssStyle} required />
